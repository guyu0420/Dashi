...
public class Restaurant {
	...
	// From Yelp API return JSON Array, we need transfer to String to store in
	// our database.
	// The front-end need the JSON Array instead of String, so transfer again.
	public static String parseString(String str) {
		// String s = "coffee\"bar"; --> coffee"bar 是一个category
		// str.replace(""","\""); replace中 " 又是特殊字符 \\ represents \ and \"
		// represent "
